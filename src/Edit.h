...
// Added on 2019-08-08
#define EDIT_FINDREPL_CHAR_LIMIT 4096 // should correspond to DLG_ITEM_MAXLEN in Helpers.h

typedef struct _editfindreplace {
    char szFind[EDIT_FINDREPL_CHAR_LIMIT];
    char szReplace[EDIT_FINDREPL_CHAR_LIMIT];
    char szFindUTF8[3 * EDIT_FINDREPL_CHAR_LIMIT];
    char szReplaceUTF8[3 * EDIT_FINDREPL_CHAR_LIMIT];
    UINT fuFlags;
    BOOL bTransformBS;
...
#ifdef JRB_BUILD
#define RTF_RECT_MARGIN_LEFT	30
#define RTF_RECT_MARGIN_TOP 	0
#define RTF_RECT_MARGIN_RIGHT	0
#define RTF_RECT_MARGIN_BOTTOM	0
